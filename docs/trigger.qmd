...
1.  **File Watcher:** Uses `inotify` to watch a YAML file on disk. It includes a 200ms debounce timer to handle "atomic" file swaps (common with Kubernetes ConfigMaps) where multiple filesystem events fire in rapid succession.
